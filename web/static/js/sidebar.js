...
function renderScheduledSessionItem(s) {
  ...
  const actions = `
    ...
    <button onclick="event.preventDefault(); event.stopPropagation(); forkSession('${s.id}')"
            class="opacity-0 group-hover:opacity-100 p-1 hover:text-green-400 transition-opacity flex-shrink-0 ${activeBtnClass}" title="Fork">
