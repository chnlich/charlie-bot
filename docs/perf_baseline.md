...
| 2026-09-01 | #572 | M26 projection advance median 46.69 ms → 0.18 ms, max 100.40 ms → 0.25 ms (collector verbatim, 8 single-event appends on the 20534-event worst live corpus, scratch CHARLIEBOT_HOME A/B, main checkout before vs branch after at load 2.35/1.88/1.51; served-view digest identical e94c56635194) | append-incremental message projection: closed-prefix single feed plus cloned-aggregator open-region view; M26 definition and healthy range introduced with this PR |
