...
print(f"{best_n / 1e6:.1f} MB worker log; newest-first scans: review-scan median {rtimes[2] * 1000:.2f} ms "
      f"(summary {len(r or '')} chars), failed-iteration judgment pair median {ptimes[2] * 1000:.2f} ms "
